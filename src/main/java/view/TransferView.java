...
public class TransferView {
    ...
    private JLabel lblBalance2 = new JLabel("Balance");
    ...
    private String selectedBalance2;
    ...
    private void updateTable() {
        ...
        ArrayList<Account> accounts = transferController.getAccounts();
        for (Account account : accounts) {
            row[0] = account.getNumber();
            row[1] = account.getBalance();
            model.addRow(row);
            row2[0] = account.getNumber();
            row2[1] = account.getBalance();
            model2.addRow(row);
        }
    ...
    private void initialize() {
        ...
        Object[] columns2 = {"Account number", "Balance"};
        ...
        JLabel lblNewLabel = new JLabel("Enter the amount to be transferred");
        ...
        table2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                selectedBalance2 = model2.getValueAt(j, 1).toString();
                number2.setText(selectedNumber2);
                balance2.setText(selectedBalance2);
            }
        });
        ...
        btnConfirm.addActionListener(e -> {
            if (transferController.transfer(user.getId(), number1.getText(), number2.getText(), amount.getText(), false) != -1) {
                updateTable();
                number1.setText("");
                balance1.setText("");
                balance2.setText("");
